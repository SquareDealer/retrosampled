...
const SampleRow = ({ sample, currentPlayingId, onPlay }) => {
  const [authorName, setAuthorName] = useState(sample.author || "Loading...");
  ...
  return (
    ...
    <div className="sample-row__center">
        ...
        <div className="sample-row__metadata">
            ...
            <div className="sample-row__type">{sample.type}</div>
        </div>
    </div>
